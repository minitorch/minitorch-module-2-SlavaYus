...
class Sigmoid(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        # TODO: Implement for Task 2.4.
        (a,) = ctx.saved_values
        b = grad_output.f.sigmoid_map(a)
        return b * (-b + 1.0) * grad_output
...
class Exp(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        ...
        return grad_output.f.mul_zip(res, grad_output)
...
class Sum(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, float]:
        ...
        return (zeros(a_shape) + 1) * grad_output, 0.0
...
class LT(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        # TODO: Implement for Task 2.4.
        res1, res2 = ctx.saved_values
        return grad_output.zeros(res1.shape), grad_output.zeros(res2.shape)
